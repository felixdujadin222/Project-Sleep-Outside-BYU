import{r as p,g as f,s as y,u as b}from"./utils-C5HVjJMU.js";import{P as w}from"./ProductData-CKx_ZSv7.js";function L(s){const e=`/Project-Sleep-Outside-BYU/${s.Image.replace(/^(\.\.\/|\.\/|\/)/,"")}`;return`<li class="product-card" style="position: relative;">
    <button 
      class="wishlist-btn" 
      data-id="${s.Id}" 
