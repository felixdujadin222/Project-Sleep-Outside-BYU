import{g as s,s as l,u as d,f as m}from"./utils-u5oOr5gz.js";function n(){const t=s("so-cart")||[];if(t.length>0){const e=t.map(c=>u(c));document.querySelector(".product-list").innerHTML=e.join("");const r=t.reduce((c,i)=>c+i.FinalPrice,0),a=document.querySelector(".cart-footer");document.querySelector(".cart-total").innerHTML=`Total: $${r.toFixed(2)}`,a.classList.remove("hide")}else{document.querySelector(".product-list").innerHTML="<p>Your cart is empty.</p>";const e=document.querySelector(".cart-footer");e&&e.classList.add("hide")}d()}function u(t){const e=m(t.Image);return`<li class="cart-card divider">
